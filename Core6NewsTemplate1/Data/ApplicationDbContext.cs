...
namespace WebOS.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Configure the Balance property on ApplicationUser entity
            builder.Entity<ApplicationUser>()
                .Property(b => b.Balance)
                .HasColumnType("decimal(18,2)") // Use appropriate precision and scale
                .HasPrecision(18, 2);

            // Configure the Amount property on Statement entity
